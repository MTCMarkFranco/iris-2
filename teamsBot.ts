...
// import { OnBehalfOfUserCredential } from "@azure/msal-node";
  ...
  constructor() {
    ...
    this.onMessage(async (context, next) => {
      ...
      const graphClient = createMicrosoftGraphClient({
        authProvider: new OnBehalfOfUserCredential({
      ...
      // const myMsalInstance = new UserAgentApplication(msalConfig);

      // const myAccount: AccountInfo = msalClient.getAccountByHomeId(homeAccountId);
      ...
      await context.sendActivity(`Echo: ${user}`);
